...
namespace TFSReporting.ExcelTools
{
    class UpdateTestCaseId
    {
        ...
        public UpdateTestCaseId()
        {

        }

        public UpdateTestCaseId(Properties props)
        {
        ...
        public void UpdateAllTestCaseId(List<TestCaseRowMapping> testCaseRowMappings)
        {
