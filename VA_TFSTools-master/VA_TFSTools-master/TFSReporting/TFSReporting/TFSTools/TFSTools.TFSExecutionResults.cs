...
namespace TFSReporting.TFSTools
{
    class TFSExecutionResults
    {
        ...
        // Populated in GatherTestCaseRunsAPI
        ...
        /// <summary>
        /// Gathers the Test Results for a specifc date. There may be duplicates for Test Cases that were run more than once on a single day,
        /// but each one will have a different TestCase.CurrentResult
        /// </summary>
        ...
        public List<TestCase> GatherTestCaseResults()
        {
            ...
            res = GetListOfTestCaseFromPlanId(_testPlanId, testCaseRuns).Result;
        ...
        /// <summary>
        /// Gather Test Cases directly from TFS and assign the testCaseRuns/Results to the correct test case. 
        /// </summary>
        /// <param name="testSuiteId"></param>
        /// <param name="path"></param>
        /// <param name="testCaseRuns"></param>
        /// <returns></returns>
        ...
        public async Task<TestCase> GatherTestCase(TestCase testCase)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                testCase.CurrentIteration = Convert.ToInt32(jo["currentIteration"]);

                return testCase;
            }
            else
            {
                Console.WriteLine("Error getting Test Case: {0}", response.Content.ReadAsStringAsync().Result);
                throw new Exception();
            }
        ...
        /// <summary>
        /// Gathers all Test Runs and populates global mapping of Test Case ID to Test Runs 
        /// </summary>
        /// <returns></returns>
