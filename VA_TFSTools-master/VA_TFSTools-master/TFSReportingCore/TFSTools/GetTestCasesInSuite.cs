...
namespace TFSReporting.TFSTools
{
    class GetTestCasesInSuite
    {
        ...
        public List<TestCase> GatherTestCases()
        {
            ...
            //}
            List<TestCase> res = GatherTestCasesInParentSuite(_testSuiteId, pathList).Result;
        ...
        private async Task<List<TestCase>> GatherTestCasesInParentSuite(int suiteId, List<string> currPath)
        {
